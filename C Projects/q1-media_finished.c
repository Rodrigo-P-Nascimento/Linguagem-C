...
float Media(float valor1, float valor2){
    ...
    /*
    O motivo da funcao nao estar retornando os valores certos eh
    por causa que a funcao esta trabalhando com numeros inteiros, 
    esta fazendo conversoes dos numeros float para int e isso esta gerando
    esses erros. Para concertar este erro basta mudar o tipo primitivo
    da funcao, os tipos de valores dos parametros e o tipo
    da variavel "soma" para float.
    */
}
