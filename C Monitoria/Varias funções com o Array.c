...
int main(void){
    ...
    */
    ...
    if(arrayOrdenada == 0){
        printf("Este Array nao esta ordenado");
    }else{
        printf("Este Array esta ordenado\n");
        if(arrayOrdenada == -1) printf("Esta em ordem decrescente.\n");
        if(arrayOrdenada == 1) printf("Estah em ordem crescente.\n");
    } 
    //Esta parte acima se refere a questao 6 do exercicio.
